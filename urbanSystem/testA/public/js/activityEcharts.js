require.config({
        ...
        require(
            ...
            function (ec) {
				var url = "http://10.10.240.120:8989/json/log/status/78/2016-01-01/2017-01-01";
				var dataSource = [];
				$.ajax({ 
						  type: "get", 
						  url: url,
				...
				function addData(){
					...
					document.getElementById("activityLastTime").innerHTML = lastTimeStr;
					//console.log("data", seriesResult);
					var myChart = ec.init(document.getElementById('activity'));
