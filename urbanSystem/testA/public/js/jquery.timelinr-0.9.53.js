...
jQuery.fn.timelinr = function(options){
	...
	$(function(){
		...
		$(settings.datesDiv+' a').click(function(event){
			...
			if(_dataAnalysisType == 'grid-heat'){
				$('.dimmer').css('display','block');
				_displayGridHeat(getTime($(this).text()))
			}else if(_dataAnalysisType == 'grid-cube'){
				$('.dimmer').css('display','block');
				_displayGridCube(getTime($(this).text()))
			}else if(_dataAnalysisType == 'block-heat'){
				$('.dimmer').css('display','block');
				_displayBlockHeat(getTime($(this).text()))
			}else if(_dataAnalysisType == 'block-OD-throughput'){
				$('.dimmer').css('display','block');
				_displayBlockOdThroughput(getTime($(this).text()),$( "#spinner" ).spinner( "value" ))
			}else{
				if(_timeUnit == 'h'){
					_loadEnvData($(this).text())
				}else if(_timeUnit == 'y'){
					$('.dimmer').css('display','block');
					_loadAnnalData($(this).text())
				}
			}
		...
		$(settings.nextButton).bind('click', function(event){
			...
			console.log($('.' + settings.issuesSelectedClass).text())
			var selected = $('.' + settings.issuesSelectedClass).text()
			if(_dataAnalysisType == 'grid-heat'){
				$('.dimmer').css('display','block');
				_displayGridHeat(getTime(selected))
			}else if(_dataAnalysisType == 'grid-cube'){
				$('.dimmer').css('display','block');
				_displayGridCube(getTime(selected))
			}else if(_dataAnalysisType == 'block-heat'){
				$('.dimmer').css('display','block');
				_displayBlockHeat(getTime(selected))
			}else if(_dataAnalysisType == 'block-OD-throughput'){
				$('.dimmer').css('display','block');
				_displayBlockOdThroughput(getTime(selected),$( "#spinner" ).spinner( "value" ))
			}else{
				if(_timeUnit == 'h'){
					_loadEnvData(selected)
				}else if(_timeUnit == 'y'){
					$('.dimmer').css('display','block');
					_loadAnnalData(selected)
				}
			}
		});
